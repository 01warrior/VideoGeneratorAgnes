      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-8 py-6 sm:py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <section className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-5 shadow-sm border border-[#e1e3e1]/80 flex flex-wrap items-center justify-between gap-4">
              <div className="text-xs text-[#444746] space-y-0.5">
                <div className="flex items-center gap-2">
                  <span className="font-bold text-[#1f1f1f]">agnes-video-v2.0</span>
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-[#f0f4f9] text-[#004a77] font-mono">
                    121 frames @ 24fps
                  </span>
                </div>
              ...
              <button
                ...
                className={`px-8 py-3.5 rounded-full font-bold text-sm tracking-wide shadow-md transition-all flex items-center gap-2.5 ${
                  isGenerating
                    ? 'bg-[#e1e3e1] text-[#747775] cursor-not-allowed'
                    : 'bg-[#00639b] hover:bg-[#004a77] text-white active:scale-98 hover:shadow-lg'
                }`}
              >
                {isGenerating ? (
                  <>
                    <Sparkles className="w-4 h-4 animate-spin text-[#00639b]" />
          ...
          <section className="lg:col-span-5 space-y-6">
            ...
            {taskStatus === 'idle' && (
              <div className="bg-white rounded-3xl p-6 sm:p-7 shadow-sm border border-[#e1e3e1]/80 space-y-5">
                <div>
